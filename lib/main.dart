...
import 'package:yandex_maps_mapkit/init.dart' as map_init;
import 'package:yandex_maps_mapkit/mapkit.dart';

void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  map_init.initMapkit(apiKey: 'API_KEY');
  runApp(const MyApp());
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<DrivingRoute?> getRouteBetweenCoordinates() async {
    var start = Coordinates();
    var end = Coordinates();
    var completer = Completer<DrivingRoute?>();
    ...
    const vehicleOptions = DrivingVehicleOptions(
      vehicleType: DrivingVehicleType.Default,
    );
